#ifndef ER2H_6LiEventHeader_H_
#define ER2H_6LiEventHeader_H_
...
class ER2H_6LiEventHeader : public FairMCEventHeader {
private:
...
public:
  ER2H_6LiEventHeader() : fTrigger(0), fTriggerPriority(0) {}
  ...
  ClassDef(ER2H_6LiEventHeader,1)
};
