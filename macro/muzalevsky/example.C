...
*/
	...
	TCut cHeLocus = "(3_He->GetTheta())*TMath::RadToDeg() < 32 && 3_He->GetT() < 20";
...
//	tr->Draw("kin.GetTritonT()/3.:kin.GetTritonTheta()*TMath::RadToDeg()", "", "same");
	...
	tr->SetMarkerColor(kGreen);
	tr->Draw("3_He->GetT()/3.:3_He->GetTheta()*TMath::RadToDeg()", cHeLocus, "same");
	tr->Draw("5_H->GetT()/5.:5_H->GetTheta()*TMath::RadToDeg()", cHeLocus, "same");
	htemp = (TH1F*)gPad->GetPrimitive("htemp");
	htemp->GetYaxis()->SetTitle("T_{lab} (MeV/A)");
	htemp->GetXaxis()->SetTitle("\\Theta_{lab} (deg)");
	htemp->SetTitle("green cut: thetaLab(3He) < 32 deg && Tlab(3He) < 20 MeV");
	...
	tr->Draw("n2->GetT():n2->GetTheta()*TMath::RadToDeg()", "", "same");
	tr->SetMarkerColor(kGreen);
	tr->Draw("n1->GetT():n1->GetTheta()*TMath::RadToDeg()", cHeLocus, "same");
	tr->Draw("n2->GetT():n2->GetTheta()*TMath::RadToDeg()", cHeLocus, "same");
	htemp = (TH1F*)gPad->GetPrimitive("htemp");
	htemp->GetYaxis()->SetTitle("T_{lab} (MeV/A)");
	htemp->GetXaxis()->SetTitle("\\Theta_{lab} (deg)");
	...
	tr->Draw("3_H_recoil->GetT()/3.:3_H_recoil->GetTheta()*TMath::RadToDeg()", "", "");
	tr->SetMarkerColor(kGreen);
	tr->Draw("3_H_recoil->GetT()/3.:3_H_recoil->GetTheta()*TMath::RadToDeg()", cHeLocus, "same");
	htemp = (TH1F*)gPad->GetPrimitive("htemp");
	htemp->GetYaxis()->SetTitle("T_{lab} (MeV/A)");
	htemp->GetXaxis()->SetTitle("\\Theta_{lab} (deg)");
