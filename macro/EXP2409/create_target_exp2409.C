...
void create_target_exp2409() {
  ...
  TString geoFileName = "target_exp2409.root";
  // --------------------------------------------------------------------------
  ...
  FairGeoMedium* mHe = geoMedia->getMedium("he4_2409");
  if ( ! mHe ) Fatal("SOS", "FairMedium he4_2409 not found");
  geoBuild->createMedium(mHe);
  TGeoMedium* pHe = gGeoMan->GetMedium("he4_2409");
  if ( ! pHe ) Fatal("SOS", "Medium he4_2409 not found"); 
  ...
  TGeoVolume* shapeD2 = new TGeoVolume("shapeD2", GasShape, pMed0); 
  // --------------------------------------------------------------------------
